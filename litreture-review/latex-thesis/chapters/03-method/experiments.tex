...
\paragraph{Setup.} Dagster deployed on the Multipass VM with default process executor.
...
\begin{description}[style=nextline]
  ...
  At level L4 (5 concurrent jobs), after all jobs are running, deliberately kill one pod mid-execution using \texttt{kubectl delete pod --force}. Measure:
