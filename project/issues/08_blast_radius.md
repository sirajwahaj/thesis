...
## Acceptance Criteria
- [ ] 3 repetitions on VM: `kill -9` one Docker container at L4, record how many other jobs fail
...
## Notes
Script: `scripts/blast_radius_vm.sh` and `scripts/blast_radius_k8s.sh`.
Run via: `make exp2b-blast`.
