...
No study gives engineers a data-backed answer to ``at what workload level does the Kubernetes migration become worth it for pipeline orchestration systems?'' This thesis fills that gap.
