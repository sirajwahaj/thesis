...
The reliability failure rates (66.7\% at L3 through 30.0\% at L6) are large effects with clear statistical significance. The startup overhead range (4--15\,s) grows with concurrency and would require additional investigation under colder image conditions or in production clusters to assess variance.
