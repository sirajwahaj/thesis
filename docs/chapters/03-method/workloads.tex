...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{clccX}
    ...
    L4  & 5  & 1 vCPU & 400\,MB & 2.0\,GB (50\% of VM) \\
    L5  & 7  & 1 vCPU & 400\,MB & 2.8\,GB (70\% of VM) \\
    L6  & 10 & 1 vCPU & 400\,MB & 4.0\,GB (100\% of VM) \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{itemize}
  ...
  \item \textbf{L4--L5} represent the over-subscription zone: more CPUs demanded than available, triggering CFS scheduling contention.
  \item \textbf{L6} is the stress level: aggregate memory demand equals total VM RAM, and CPU demand is 2.5$\times$ the available cores.
  \item Level labels are sequential (L1--L6) mapped to concurrency counts (1, 2, 3, 5, 7, 10) to concentrate measurements at key inflection points rather than distributing uniformly.
\end{itemize}
