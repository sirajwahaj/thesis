dataplattformar med verktyg som Kubernetes, Terraform och Google Cloud Platform (GCP). Min
\section{Inledning}
\label{sec:inledning}
...
och min handledare var Amir Jaber (amir@insighta.io). LIA-perioden pågick från januari till
maj 2026.
